...
function Login() {
  ...
  const handleLogin = async () => {
    try {
      // const loginResponse = await window.api.login(credentials);
      const loginResponse = { email: "olaiaaly", success: true };
  ...
  return (
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-3 text-center text-sm/6 text-red-500">
          {" "}
        ...
        <div className="mt- sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-6" id="login-form">
            <div>
              <label
                htmlFor="email"
